    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown {{
                active_class(Active::checkUriPattern('admin/drinks*'), 'open')
            }}">
                <a class="nav-link nav-dropdown-toggle {{
                    active_class(Active::checkUriPattern('admin/drinks*'), 'active')
                }}" href="#">
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link {{
                            active_class(Active::checkUriPattern('admin/drinks*'))
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{
                            active_class(Active::checkUriPattern('admin/drinks/create*'))
                        }}" href="{{ route('admin.drinks.create') }}">
